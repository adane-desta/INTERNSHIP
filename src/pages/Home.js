...
import Fcompany from '../components/Fcompany'; // Importing the Fcompany component  
        ...
        <div className="container">
          ...
          <div className="property-grid">
            {filteredProperties.length === 0 ? (
              <p>Sorry! No properties found. Try different type.</p>
            ) : (
                ...
                <div className="property-card" key={index}>
                  ...
                  <div className="property-details">
                    ...
                    <div className="property-footer">
                      <button className="btn-outline btn-primary">View Details</button>
...
<Fcompany /> {/* Featured Companies Section */}
